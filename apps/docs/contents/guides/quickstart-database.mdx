...
- A second-price auction can be created.
- Bidders and bids are stored with the expected data.
- Auction resolution selects the highest bidder.
- Settlement records use the second-highest bid for payment calculations.
