 ...
 */
export function validateBid(bid, auction, options = {}) {
 ...
 */
export function validateBids(bids, auction, options = {}) {
 ...
 */
export function filterValidBids(bids, auction, options = {}) {
 ...
 */
export function validateAuctionResolution(auction, bids) {
    const errors = [];
 ...
 */
export function isValidBidAmount(amount) {
 ...
 * @returns True if valid
 */
export function isValidBidderId(bidderId) {
